<div class="images index">
	...
	<tr>
		...
		<td>
			<?php echo $this->Html->link($image['User']['id'], array('controller' => 'users', 'action' => 'view', $image['User']['id'])); ?>
		</td>
		<td class="actions">
...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Choose Scenario'), array('controller' => 'images', 'action' => 'display_scenarios')); ?></li>
		<li><?php echo $this->Html->link(__('View Images'), array('controller' => 'images', 'action' => 'display_images')); ?></li>
